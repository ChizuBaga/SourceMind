...
def get_embedding_function():
    return HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2", show_progress=True, model_kwargs={"device":"cpu"}, endcoder_kwargs={"normalize_embeddings": False})
